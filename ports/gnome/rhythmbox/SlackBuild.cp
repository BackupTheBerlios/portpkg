...
cp -a \
  AUTHORS COPYING ChangeLog INSTALL NEWS README README.iPod THANKS TODO \
...
find $PKG/ -name "*.schemas" | sed "s,^$PKG/,gconf ,g" >>$PKG/install/doinst.sh
